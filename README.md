# 🎓 Estudos e Projetos Acadêmicos (Java)

Este repositório centraliza os algoritmos, estruturas de dados e conceitos fundamentais desenvolvidos durante a minha graduação em **Ciência da Computação**. O objetivo é documentar a evolução técnica e aplicar na prática os conceitos teóricos abordados em aula.
...
2. Clone o repositório:
   ```bash
   git clone [https://github.com/novaes11/Java-annotation.git](https://github.com/novaes11/Java-annotation.git)
