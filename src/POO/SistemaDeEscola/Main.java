...
/**
 * Classe principal para demonstrar o sistema de gerenciamento escolar.
 * Cria instâncias de alunos, professores, funcionários e turmas,
 * e exibe suas informações e interações.
 */
public class Main {
    /**
    ...
    public static void main(String[] args) {
        // ... (o conteúdo do método é muito longo para ser incluído aqui, mas permanece o mesmo)
        int counter = 0;
