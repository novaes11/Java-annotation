package src.AlgoritmosDeOrdenação;

import src.AlgoritmosDeOrdenação.Analise.Analisador;
import src.AlgoritmosDeOrdenação.Apresentador.ApresentadorConsole;
import src.AlgoritmosDeOrdenação.Apresentador.ApresentadorResultados;
import src.AlgoritmosDeOrdenação.MetodosDeOrdenação.*;
import src.AlgoritmosDeOrdenação.Resultados.Resultado;
