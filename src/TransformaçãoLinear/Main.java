...
/**
 * Aplicação de console para realizar várias transformações lineares em um ponto 2D.
 */
public class Main {
    /**
     * Ponto de entrada da aplicação. Exibe um menu para o usuário escolher
     * uma transformação (escala, reflexão, rotação) e aplica-a a um ponto
